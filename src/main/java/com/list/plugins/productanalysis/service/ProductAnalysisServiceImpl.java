package com.list.plugins.productanalysis.service;
 ...
 * @Version v1.0
 **/
public class ProductAnalysisServiceImpl extends BasePluginService {

    public ProductAnalysisServiceImpl(ChatReqDTO chatReqDTO, IntentInfoBo intentInfoBo, CountDownLatch countDownLatch) {
